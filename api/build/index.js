...
// route-module:C:\Temp\React-Dev\Remix\Tutorial-Blog-Runthrough\remix-blog-part2-walkthrough\app\root.jsx
var root_exports = {};
...
function Layout({ children }) {
  ...
  return /* @__PURE__ */ React.createElement("div", {
    ...
    to: "/login"
  }, "Login")) : /* @__PURE__ */ React.createElement("li", null, /* @__PURE__ */ React.createElement(import_remix3.Link, {
    to: "/auth/logout"
...
// route-module:C:\Temp\React-Dev\Remix\Tutorial-Blog-Runthrough\remix-blog-part2-walkthrough\app\routes\auth\register.jsx
...
// route-module:C:\Temp\React-Dev\Remix\Tutorial-Blog-Runthrough\remix-blog-part2-walkthrough\app\routes\demos\actions.jsx
var actions_exports = {};
...
// route-module:C:\Temp\React-Dev\Remix\Tutorial-Blog-Runthrough\remix-blog-part2-walkthrough\app\routes\demos\correct.jsx
var correct_exports = {};
...
// route-module:C:\Temp\React-Dev\Remix\Tutorial-Blog-Runthrough\remix-blog-part2-walkthrough\app\routes\demos\params.jsx
var params_exports = {};
...
// route-module:C:\Temp\React-Dev\Remix\Tutorial-Blog-Runthrough\remix-blog-part2-walkthrough\app\routes\demos\params\index.jsx
var params_exports2 = {};
...
// route-module:C:\Temp\React-Dev\Remix\Tutorial-Blog-Runthrough\remix-blog-part2-walkthrough\app\routes\demos\params\$id.jsx
var id_exports = {};
__export(id_exports, {
...
var loader2 = async ({ params }) => {
  ...
  if (params.id === "shh-its-a-secret") {
    throw (0, import_remix9.json)({ webmasterEmail: "hello@remix.run" }, { status: 401 });
  }
  if (params.id === "kaboom") {
    lol();
  }
...
// route-module:C:\Temp\React-Dev\Remix\Tutorial-Blog-Runthrough\remix-blog-part2-walkthrough\app\routes\auth\forgot.jsx
var forgot_exports = {};
...
var action3 = async ({ request }) => {
  ...
  return (0, import_remix10.redirect)("/login");
};
function Login() {
  return /* @__PURE__ */ React.createElement("div", {
    className: "loginContainer"
    ...
    className: "authTitle"
  }, /* @__PURE__ */ React.createElement("h1", null, "Forgot Password?")), /* @__PURE__ */ React.createElement(import_remix10.Form, {
    method: "post"
    ...
    className: "additionalLinks"
  }, "Not Yet Registered?  ", /* @__PURE__ */ React.createElement(import_remix10.Link, {
    to: "/auth/register"
  }, "Register")));
}

// route-module:C:\Temp\React-Dev\Remix\Tutorial-Blog-Runthrough\remix-blog-part2-walkthrough\app\routes\auth\logout.jsx
var logout_exports = {};
...
// route-module:C:\Temp\React-Dev\Remix\Tutorial-Blog-Runthrough\remix-blog-part2-walkthrough\app\routes\blogs\$slug.jsx
var slug_exports = {};
...
function PostSlug() {
  let post = (0, import_remix12.useLoaderData)();
  return /* @__PURE__ */ React.createElement("div", {
...
// route-module:C:\Temp\React-Dev\Remix\Tutorial-Blog-Runthrough\remix-blog-part2-walkthrough\app\routes\blogs\index.jsx
var blogs_exports = {};
...
function Posts() {
  let posts = (0, import_remix13.useLoaderData)();
  return /* @__PURE__ */ React.createElement("div", null, /* @__PURE__ */ React.createElement("h1", null, "My Remix Blog"), /* @__PURE__ */ React.createElement("p", null, "Click on the post name to read the post"), /* @__PURE__ */ React.createElement("div", null, /* @__PURE__ */ React.createElement(import_remix13.Link, {
    to: "/admin"
...
// route-module:C:\Temp\React-Dev\Remix\Tutorial-Blog-Runthrough\remix-blog-part2-walkthrough\app\routes\demos\about.jsx
var about_exports = {};
...
function Index() {
  ...
  }, "read all about nested routes in the docs"), "."), /* @__PURE__ */ React.createElement("hr", null), /* @__PURE__ */ React.createElement(import_remix14.Outlet, null)));
}

// route-module:C:\Temp\React-Dev\Remix\Tutorial-Blog-Runthrough\remix-blog-part2-walkthrough\app\routes\demos\about\index.jsx
var about_exports2 = {};
...
// route-module:C:\Temp\React-Dev\Remix\Tutorial-Blog-Runthrough\remix-blog-part2-walkthrough\app\routes\admin.jsx
var admin_exports = {};
...
async function loader6({ request }) {
  const session = await getSession(request.headers.get("Cookie"));
  if (!session.has("access_token")) {
    return (0, import_remix17.redirect)("/login");
  }
  const data = { error: session.get("error") };
  return (0, import_remix17.json)(data, {
    headers: {
      "Set-Cookie": await commitSession(session)
    }
  }), getPosts();
...
function Admin() {
  let posts = (0, import_remix17.useLoaderData)();
  return /* @__PURE__ */ React.createElement("div", {
    className: "admin"
    ...
    to: post.slug
  }, post.title)))), /* @__PURE__ */ React.createElement("main", null, /* @__PURE__ */ React.createElement(import_remix17.Outlet, null))));
}

// route-module:C:\Temp\React-Dev\Remix\Tutorial-Blog-Runthrough\remix-blog-part2-walkthrough\app\routes\admin\$edit.jsx
var edit_exports = {};
...
function PostSlug2() {
  ...
  let post = (0, import_remix18.useLoaderData)();
  return /* @__PURE__ */ React.createElement(React.Fragment, null, /* @__PURE__ */ React.createElement(import_remix18.Form, {
    method: "post"
  ...
  }, transition.submission ? "Updating..." : "Update Post"))), /* @__PURE__ */ React.createElement(import_remix18.Form, {
    method: "delete"
  }, /* @__PURE__ */ React.createElement("p", null, /* @__PURE__ */ React.createElement("input", {
    className: "hiddenBlogID",
    name: "id",
...
// route-module:C:\Temp\React-Dev\Remix\Tutorial-Blog-Runthrough\remix-blog-part2-walkthrough\app\routes\admin\index.jsx
var admin_exports2 = {};
...
// route-module:C:\Temp\React-Dev\Remix\Tutorial-Blog-Runthrough\remix-blog-part2-walkthrough\app\routes\admin\new.jsx
var new_exports = {};
...
function NewPost() {
  let errors = (0, import_remix20.useActionData)();
  let transition = (0, import_remix20.useTransition)();
  let slug = "";
  ...
  return /* @__PURE__ */ React.createElement(import_remix20.Form, {
    method: "post"
  }, /* @__PURE__ */ React.createElement("p", null, /* @__PURE__ */ React.createElement("label", {
    htmlFor: ""
  }, "Post Title: ", " ", " ", (errors == null ? void 0 : errors.title) && /* @__PURE__ */ React.createElement("em", null, "Title is required"), " ", /* @__PURE__ */ React.createElement("input", {
...
// route-module:C:\Temp\React-Dev\Remix\Tutorial-Blog-Runthrough\remix-blog-part2-walkthrough\app\routes\index.jsx
var routes_exports = {};
...
async function loader8({ request }) {
  ...
  if (session.has("access_token")) {
    const data = { user: auth.currentUser, error: session.get("error") };
    return (0, import_remix21.json)(data, {
      headers: {
        "Set-Cookie": await commitSession(session)
      }
    });
...
var action6 = async ({ request }) => {
  let session = await getSession(request.headers.get("Cookie"));
  return (0, import_remix21.redirect)("/login", {
    headers: { "Set-Cookie": await destroySession(session) }
  });
};
var meta5 = () => {
...
// route-module:C:\Temp\React-Dev\Remix\Tutorial-Blog-Runthrough\remix-blog-part2-walkthrough\app\routes\login.jsx
var login_exports = {};
...
async function loader9({ request }) {
  const session = await getSession(request.headers.get("Cookie"));
  if (session.has("access_token")) {
    return (0, import_remix22.redirect)("/blogs");
  }
  const data = { error: session.get("error") };
  return (0, import_remix22.json)(data, {
    headers: {
      "Set-Cookie": await commitSession(session)
    }
  });
...
function Login2() {
  ...
  return /* @__PURE__ */ React.createElement("div", {
    ...
    className: "authTitle"
  }, /* @__PURE__ */ React.createElement("h1", null, "Login")), /* @__PURE__ */ React.createElement(import_remix22.Form, {
    method: "post"
  }, /* @__PURE__ */ React.createElement("label", {
    htmlFor: "email"
  }, "Email"), /* @__PURE__ */ React.createElement("input", {
    ...
    to: "/auth/register"
  }, "Register"), /* @__PURE__ */ React.createElement(import_remix22.Link, {
    to: "/auth/forgot"
